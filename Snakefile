...
rule rulegraph:
    ...
    shell:
        ...
        snakemake --rulegraph dot --configfile {input.config_file} --quiet | sed -n "/digraph/,\$p" > {output.dot}
...
rule filegraph:
    ...
    shell:
        ...
        snakemake --filegraph dot --configfile {input.config_file} --quiet | sed -n "/digraph/,\$p" > {output.dot}
